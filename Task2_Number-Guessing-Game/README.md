...
The computer randomly selects a number and your task is to guess it with the hints provided. 🔢✨
...
📌 How the Game Works
1️⃣ The program picks a random number
...
''' Enter your guess: 50 Too High! Try again Enter your guess: 25 Too Low! Try again Enter your guess: 30 🎉 Congratulations! You guessed the number! '''
...
📂 File Structure
📁 Number Guessing Game ├── Main.java └── README.md
